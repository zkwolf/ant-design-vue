  ...
  <a-typography>
    ...
    <a-typography-paragraph>
      ...
      <a-typography-text strong>
        ...
        front-end development </a-typography-text
      >.
    </a-typography-paragraph>
    ...
    <a-typography-paragraph>
      Press
      <a-typography-text keyboard>Esc</a-typography-text>to exit...
    </a-typography-paragraph>
    ...
    <a-typography-paragraph
      >蚂蚁的企业级产品是一个庞大且复杂的体系。这类产品不仅量级巨大且功能复杂，而且变动和并发频繁，常常需要设计与开发能够快速的做出响应。同时这类产品中有存在很多类似的页面以及组件，可以通过抽象得到一些稳定且高复用性的内容。</a-typography-paragraph
    >
    <a-typography-paragraph>
    ...
    <a-typography-paragraph>
      ...
      <a-typography-text code>Sketch</a-typography-text>和
    ...
    <a-typography-paragraph>
      按
      <a-typography-text keyboard>Esc</a-typography-text>键退出阅读……
    </a-typography-paragraph>
  </a-typography>
</template>
